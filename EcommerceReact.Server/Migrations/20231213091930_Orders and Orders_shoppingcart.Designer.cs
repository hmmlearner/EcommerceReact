...
namespace EcommerceReact.Server.Migrations
{
    ...
    [Migration("20231213091930_Orders and Orders_shoppingcart")]
    partial class OrdersandOrders_shoppingcart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Models.Order_ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.ShoppingCartItem", b =>
                {
                    ...
                    b.Property<int?>("Order_ShoppingCartId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Order_ShoppingCartId");
            ...
            modelBuilder.Entity("Ecommerce.Models.ShoppingCartItem", b =>
                {
                    b.HasOne("Ecommerce.Models.Order_ShoppingCart", null)
                        .WithMany("Items")
                        .HasForeignKey("Order_ShoppingCartId");
